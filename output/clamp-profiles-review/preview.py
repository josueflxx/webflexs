...
class Handler(SimpleHTTPRequestHandler):
 ...
 def translate_path(self,path):
  ...
  if '..' in Path(name).parts:return str(PROJECT/'output/clamp-profiles-review/missing')
  return finders.find(name) or str(PROJECT/'output/clamp-profiles-review/missing')
print('DIMENSIONS PREVIEW http://127.0.0.1:8776',flush=True)
