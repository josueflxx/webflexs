...
# 1. Corrected spaces in {% if order.status == value %}
# 2. Single-line tags for total and discount
...
<div class="admin-form-container" style="max-width: 900px;">
    ...
    <div class="form-actions" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <a href="{% url 'admin_order_delete' order.pk %}" class="btn btn-danger" style="background-color: #dc3545; color: white; border: none;">Eliminar Pedido</a>
    </div>
</div>
{% endblock %}
"""
...
if "Eliminar Pedido" in read_content:
     print("VERIFICATION SUCCESS: Delete button present")
else:
     print("VERIFICATION FAILED: Delete button missing")
