...
urlpatterns = [
    ...
    path('productos/<int:pk>/', views.product_workspace, name='admin_product_workspace'),
    ...
    path('productos/marca-masiva/', views.product_bulk_brand_update, name='admin_product_bulk_brand'),
    ...
    path('clientes/revisiones-fiscales/', views.client_fiscal_review_list, name='admin_client_fiscal_review_list'),
    path('clientes/revisiones-fiscales/<int:pk>/resolver/', views.client_fiscal_review_resolve, name='admin_client_fiscal_review_resolve'),
    path('clientes/tareas/', views.client_task_inbox, name='admin_client_task_inbox'),
    path('clientes/<int:pk>/tareas/', views.client_tasks, name='admin_client_tasks'),
    path('clientes/<int:pk>/tareas/crear/', views.client_task_create, name='admin_client_task_create'),
    path('clientes/<int:pk>/tareas/<int:task_id>/estado/', views.client_task_set_status, name='admin_client_task_set_status'),
    path('clientes/<int:pk>/pedidos/', views.client_order_history, name='admin_client_order_history'),
    path('clientes/<int:pk>/movimientos/<int:tx_id>/estado/', views.client_transaction_set_state, name='admin_client_transaction_set_state'),
    ...
    path('clientes/<int:pk>/password-reset-email/', views.client_password_reset_email, name='admin_client_password_reset_email'),
    ...
    path('pedidos-web/', views.order_request_list, name='admin_order_request_list'),
    path('pedidos-web/<int:pk>/', views.order_request_detail, name='admin_order_request_detail'),
    path('pedidos-web/<int:pk>/confirmar/', views.order_request_confirm_view, name='admin_order_request_confirm'),
    path('pedidos-web/<int:pk>/rechazar/', views.order_request_reject_view, name='admin_order_request_reject'),
    path('pedidos-web/<int:pk>/proponer/', views.order_request_propose_view, name='admin_order_request_propose'),
    path('pedidos-web/<int:pk>/convertir/', views.order_request_convert_view, name='admin_order_request_convert'),
    path('pedidos-web/<int:pk>/cotizacion/', views.order_request_generate_quote_view, name='admin_order_request_generate_quote'),
    path('pedidos-web/<int:pk>/factura/', views.order_request_generate_invoice_view, name='admin_order_request_generate_invoice'),
    ...
    path('ventas/vendedores/', views.seller_performance_report, name='admin_seller_performance'),
    ...
    path('pedidos/<int:pk>/items/<int:item_id>/editar/', views.order_item_edit, name='admin_order_item_edit'),
    ...
    path('pedidos/<int:pk>/eliminar-definitivo/', views.order_hard_delete, name='admin_order_hard_delete'),
    ...
    path('documentos/<int:doc_id>/excel/', views.internal_document_excel, name='admin_internal_document_excel'),
    path('documentos/<int:doc_id>/eliminar/', views.internal_document_delete, name='admin_internal_document_delete'),
    path('documentos/<str:document_kind>/<int:pk>/situacion/', views.commercial_document_situation_update, name='admin_commercial_document_situation_update'),
    ...
    path('fiscal/documentos/<int:pk>/recuperar/', views.fiscal_document_recover, name='admin_fiscal_document_recover'),
    ...
    path('fiscal/documentos/<int:pk>/enviar-email/', views.fiscal_document_send_email, name='admin_fiscal_document_send_email'),
    path('fiscal/documentos/<int:pk>/eliminar/', views.fiscal_document_delete, name='admin_fiscal_document_delete'),
    path('fiscal/documentos/<int:pk>/imprimir/', views.fiscal_document_print, name='admin_fiscal_document_print'),
    path('fiscal/documentos/<int:pk>/excel/', views.fiscal_document_excel, name='admin_fiscal_document_excel'),
    ...
    path('marcas/estructura/', views.brand_structure_manage, name='admin_brand_structure'),
    path('marcas/estructura/lotes/<int:pk>/', views.brand_structure_batch, name='admin_brand_structure_batch'),
    path('marcas/estructura/lotes/<int:pk>/aplicar/', views.brand_structure_apply, name='admin_brand_structure_apply'),
    path('marcas/estructura/lotes/<int:pk>/deshacer/', views.brand_structure_undo, name='admin_brand_structure_undo'),
    path('marcas/integrar-categorias/', views.brand_category_integration, name='admin_brand_category_integration'),
    path('marcas/integrar-categorias/guardar/', views.brand_category_mapping_save, name='admin_brand_category_mapping_save'),
    path('marcas/catalogar/', views.brand_catalog_inbox, name='admin_brand_catalog_inbox'),
    path('marcas/catalogar/asignar/', views.brand_catalog_assign, name='admin_brand_catalog_assign'),
    path('marcas/catalogar/exportar/', views.brand_catalog_export, name='admin_brand_catalog_export'),
    path('marcas/catalogar/configuracion/', views.brand_catalog_settings, name='admin_brand_catalog_settings'),
    path('marcas/catalogar/alias/nuevo/', views.brand_alias_create, name='admin_brand_alias_create'),
    path('marcas/catalogar/alias/<int:pk>/eliminar/', views.brand_alias_delete, name='admin_brand_alias_delete'),
    path('marcas/catalogar/reglas/nueva/', views.brand_catalog_rule_create, name='admin_brand_catalog_rule_create'),
    path('marcas/catalogar/reglas/<int:pk>/eliminar/', views.brand_catalog_rule_delete, name='admin_brand_catalog_rule_delete'),
    path('marcas/catalogar/lotes/<int:pk>/deshacer/', views.brand_catalog_batch_undo, name='admin_brand_catalog_batch_undo'),
    ...
    path('marcas/subrubros/<int:pk>/productos/agregar-lote/', views.brand_subrubro_bulk_assign, name='admin_brand_subrubro_bulk_assign'),
    path('marcas/subrubros/<int:pk>/productos/quitar-lote/', views.brand_subrubro_bulk_remove, name='admin_brand_subrubro_bulk_remove'),
    ...
    path('marcas/rubros/<int:pk>/productos/agregar-lote/', views.brand_rubro_bulk_assign, name='admin_brand_rubro_bulk_assign'),
    path('marcas/rubros/<int:pk>/productos/quitar-lote/', views.brand_rubro_bulk_remove, name='admin_brand_rubro_bulk_remove'),
    ...
    path('configuracion/tipos-venta/nuevo/', views.sales_document_type_create, name='admin_sales_type_create'),
    path('configuracion/tipos-documento/<int:pk>/editar/', views.sales_document_type_edit, name='admin_sales_document_type_edit'),
    path('configuracion/tipos-venta/<int:pk>/editar/', views.sales_document_type_edit, name='admin_sales_type_edit'),
    ...
    path('configuracion/tipos-venta/<int:pk>/toggle/', views.sales_document_type_toggle_enabled, name='admin_sales_type_toggle_enabled'),
    path('configuracion/tipos-documento/<int:pk>/eliminar/', views.sales_document_type_delete, name='admin_sales_document_type_delete'),
    path('configuracion/tipos-venta/<int:pk>/eliminar/', views.sales_document_type_delete, name='admin_sales_type_delete'),
    ...
    path('configuracion/depositos/<int:pk>/inicializar-stock/', views.warehouse_stock_initialize, name='admin_warehouse_stock_initialize'),
    ...
    path('admins/<int:user_id>/password-reset-email/', views.admin_user_send_password_reset_email, name='admin_user_password_reset_email'),
